var Stats = function () {
    ...
    infoText.addEventListener('mouseover', function () {
        infoText.style.backgroundColor = 'rgba(139, 69, 19, 0.4)'; // Lower opacity on hover
    });

    infoText.addEventListener('mouseout', function () {
        infoText.style.backgroundColor = 'rgba(139, 69, 19, 0.7)'; // Reset opacity when not hovering
    });
